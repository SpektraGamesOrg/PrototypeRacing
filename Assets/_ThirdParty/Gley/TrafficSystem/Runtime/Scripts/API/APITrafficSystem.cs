...
namespace Gley.TrafficSystem
{
    public static class API
    {
        ...
        public static Dictionary<System.Type, VehicleBehaviour> GetActiveBehaviours(int vehicleIndex)
        {
#if GLEY_TRAFFIC_SYSTEM
        ...
        {
#if GLEY_TRAFFIC_SYSTEM
            return TrafficManager.Instance.BehaviourManager?.GetBehaviour(vehicleIndex, typeof(T));
#else
            return null;
#endif
        }
        ...
        {
#if GLEY_TRAFFIC_SYSTEM
            TrafficManager.Instance.BehaviourManager?.StartBehaviour(vehicleIndex, typeof(T), parameters);
#endif
        }
        ...
        {
#if GLEY_TRAFFIC_SYSTEM
            TrafficManager.Instance.BehaviourManager?.StopBehaviour(vehicleIndex, typeof(T));
#endif
        }
