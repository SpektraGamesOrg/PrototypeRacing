...
/// <summary>
/// Custom inspector for RCC_Settings components.
/// </summary>
...
public class RCC_SettingsEditor : Editor {
    ...
    private PhysicsMaterial[] physicMaterials;
    ...
    public override void OnInspectorGUI() {
        ...
        if (foldControllerSettings) {
            ...
            if (GUILayout.Button("Edit Inputs") && RCC_AssetPaths.Instance && RCC_AssetPaths.Instance.inputActionMap)
                Selection.activeObject = Resources.Load(RCC_AssetPaths.Instance.inputActionMap.name);
        ...
        if (foldWheelPhysics) {
            ...
            if (RCC_GroundMaterials.Instance && RCC_GroundMaterials.Instance.frictions != null && RCC_GroundMaterials.Instance.frictions.Length > 0) {

                EditorGUILayout.BeginVertical(GUI.skin.box);
                GUILayout.Label("Ground Physic Materials", EditorStyles.boldLabel);

                physicMaterials = new PhysicsMaterial[RCC_GroundMaterials.Instance.frictions.Length];
        ...
        if (foldTagsAndLayers) {
            ...
            if (RCCSettingsAsset.setLayers) {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("PropLayer"), new GUIContent("Prop Layer"), false);
                GUI.color = new Color(.75f, 1f, .75f);
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("lensflareURP"), new GUIContent("Lensflare URP"), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("colliderMaterial"), new GUIContent("Collider Material"), false);
        ...
        EditorGUILayout.LabelField("Ekrem Bugra Ozdoganlar", EditorStyles.centeredGreyMiniLabel, GUILayout.MaxHeight(50f));
